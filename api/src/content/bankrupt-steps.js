...
export const STEPS = [
    {
      ...
      "items": [
        ...
        },
        {
          ...
          "must": "필수",
          "guide": "과다한 도박·낭비, 재산 처분·은닉, 의무·방법·시기와 다른 특정 채권자 변제, 허위 기재 등은 면책심사 대상이 될 수 있습니다. 통상적인 지급까지 모두 편파변제인 것은 아니므로 거래 시기·상대방·방법·사용처를 숨기지 말고 정리하세요."
        },
        {
          "id": "b2-4",
